  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 prose prose-sm text-ink leading-relaxed">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">一、服务说明</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">二、账号规则</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">三、内容发布规范</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">四、用户承诺</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">五、知识产权</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">六、责任限制</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">七、协议修改</h2>
        <p className="mb-3">
          本平台有权根据需要修改本协议条款。修改后的协议将在平台公布，并自公布之日起生效。用户继续使用本平台服务即视为同意修改后的协议。如用户不同意修改内容，应停止使用本平台服务。
        </p>

        <h2 className="text-base font-semibold text-ink mt-8 mb-3">八、争议解决</h2>
        <p className="mb-3">
          本协议的订立、执行和解释及争议的解决均适用中华人民共和国法律。如双方就本协议内容或其执行发生任何争议，应首先通过友好协商解决；协商不成的，任何一方均可向本平台运营方所在地有管辖权的法院提起诉讼。
        </p>

        <h2 className="text-base font-semibold text-ink mt-8 mb-3">九、联系我们</h2>
        <p className="mb-3">
