  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 prose prose-sm text-gray-700 leading-relaxed">
        ...
        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">一、我们收集的信息</h2>

        <h3 className="text-sm font-medium text-gray-700 mt-5 mb-2">1.1 账号信息</h3>
        <p className="mb-3">
          当您注册和使用PetPal时，我们会收集您的手机号码。这是创建账号和身份验证的必要信息。
        </p>

        <h3 className="text-sm font-medium text-gray-700 mt-5 mb-2">1.2 宠物信息</h3>
        <p className="mb-3">
          当您创建宠物档案时，我们会收集您宠物的姓名、类型、品种、生日、性别、体型、性格标签、简介和头像等信息。这些信息用于在社区中展示宠物身份和进行社交匹配。
        </p>

        <h3 className="text-sm font-medium text-gray-700 mt-5 mb-2">1.3 健康信息</h3>
        <p className="mb-3">
          当您使用健康管理功能时，我们会收集宠物的体重、绝育状态、疫苗记录、驱虫记录、过敏史、病史、用药记录和就诊记录等健康相关信息。这些信息用于提供个性化的健康管理和AI健康建议。
        </p>

        <h3 className="text-sm font-medium text-gray-700 mt-5 mb-2">1.4 位置信息</h3>
        <p className="mb-3">
          当您使用位置相关功能（如附近场所、约玩推荐）时，经您授权后我们会收集您选择的位置信息（城市、区域、经纬度）。您可以在设备设置中随时关闭位置权限。
        </p>

        <h3 className="text-sm font-medium text-gray-700 mt-5 mb-2">1.5 内容信息</h3>
        <p className="mb-3">
          当您发布帖子、评论、私信或其他内容时，我们会收集您发布的内容及相关的元数据（如发布时间）。
        </p>

        <h3 className="text-sm font-medium text-gray-700 mt-5 mb-2">1.6 设备信息</h3>
        <p className="mb-3">
          为保障服务正常运行和安全防护，我们会收集设备型号、操作系统版本、IP地址和访问日志等技术信息。
        </p>

        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">二、信息的使用</h2>
        ...
        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">三、信息的共享</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">四、信息的存储与保护</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">五、信息的保留</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">六、您的权利</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">七、Cookie的使用</h2>
        <p className="mb-3">
          我们使用必要的Cookie来维持您的登录状态和会话安全。我们不使用Cookie进行跨站追踪或广告投放。您可以通过浏览器设置管理或禁用Cookie，但这可能影响平台部分功能的正常使用。
        </p>

        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">八、未成年人保护</h2>
        <p className="mb-3">
          本平台主要面向年满18周岁的用户。如您未满18周岁，请在监护人陪同下阅读本政策并使用本平台。如我们发现在未获得监护人同意的情况下收集了未成年人的个人信息，我们将及时删除。
        </p>

        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">九、政策的更新</h2>
        <p className="mb-3">
          我们可能会不时更新本隐私政策。更新后的政策将在平台公布，重大变更将通过站内通知或其他适当方式告知。请您定期查看本政策。
        </p>

        <h2 className="text-base font-semibold text-gray-800 mt-8 mb-3">十、联系我们</h2>
        <p className="mb-3">
