  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 prose prose-sm text-ink leading-relaxed">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">一、AI健康助手的性质与限制</h2>
        <p className="mb-3">
          PetPal提供的AI健康助手（以下简称"本功能"）是基于人工智能技术开发的辅助信息工具，旨在为宠物主人提供宠物健康相关的参考信息和建议。
        </p>
        <p className="mb-3">
          <strong className="text-rose-600">本功能不是兽医、不是医疗设备、不是诊断工具，其提供的任何信息、建议或分析均不构成兽医诊断、处方或治疗建议。</strong>
        </p>
        <p className="mb-3">
          AI生成的内容可能存在以下局限：
        </p>
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">二、不替代专业兽医诊断</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">三、紧急情况处理</h2>
        <p className="mb-3">
          <strong className="text-rose-600">如您的宠物出现任何紧急情况（如呼吸困难、严重外伤、中毒、抽搐、意识丧失等），请立即联系最近的宠物医院或兽医急救中心，不要依赖AI健康助手获取紧急处理建议。</strong>
        </p>

        <h2 className="text-base font-semibold text-ink mt-8 mb-3">四、用户责任</h2>
        <p className="mb-3">
          使用AI健康助手即表示您理解并同意：
        </p>
        <ul className="list-disc pl-5 mb-3 space-y-1">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">五、健康记录功能说明</h2>
        <p className="mb-3">
          PetPal提供的健康记录管理功能（包括体重记录、疫苗记录、驱虫记录、就诊记录等）是为方便用户管理宠物健康信息而设计的辅助工具。该功能不构成健康评估或诊断。用户应自行核实记录信息的准确性。
        </p>

        <h2 className="text-base font-semibold text-ink mt-8 mb-3">六、免责条款</h2>
        <p className="mb-3">
        ...
        <h2 className="text-base font-semibold text-ink mt-8 mb-3">七、声明的更新</h2>
        <p className="mb-3">
          我们可能会不时更新本免责声明。更新后的声明将在平台公布，届时使用本功能即表示接受更新后的条款。
        </p>

        <h2 className="text-base font-semibold text-ink mt-8 mb-3">八、联系我们</h2>
        <p className="mb-3">
