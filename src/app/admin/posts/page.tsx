              ...
              <table className="w-full text-sm">
                <thead className="bg-surface-alt border-b border-border">
                  <tr>
                    ...
                    <th className="text-left px-4 py-3 font-medium text-ink-muted">发布者</th>
                    <th className="text-left px-4 py-3 font-medium text-ink-muted">状态</th>
                    <th className="text-left px-4 py-3 font-medium text-ink-muted">发布时间</th>
                ...
                <tbody className="divide-y divide-border-light">
                  {posts.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="text-center py-10 text-ink-faded">
                        暂无数据
                      </td>
                    </tr>
                  ) : (
